...
import com.nhnent.tardis.sample.session.handlers.SampleReqSessionUserAgentPacketHandler;
...
public class SampleSessionUserAgent extends SessionUserAgent implements ISessionUser {
    ...
    static {
        dispatcher.registerMsg(Sample.SampleReq.class, SampleReqSessionUserAgentPacketHandler.class);
    }
