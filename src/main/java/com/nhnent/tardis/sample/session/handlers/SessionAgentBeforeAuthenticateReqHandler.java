...
public class SessionAgentBeforeAuthenticateReqHandler implements IPacketHandler<SampleSessionAgent> {
    ...
    public void execute(SampleSessionAgent sessionAgent, Packet packet) throws SuspendExecution {
        try{
            ...
            logger.info("SessionAgentBeforeAuthenticateReqHandler : {}", message);
