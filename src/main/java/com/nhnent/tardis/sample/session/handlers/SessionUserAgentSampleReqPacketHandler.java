...
public class SessionUserAgentSampleReqPacketHandler implements IPacketHandler<SampleSessionUserAgent> {
    ...
    public void execute(SampleSessionUserAgent sessionUserAgent, Packet packet) throws SuspendExecution {
        try{
            ...
            logger.info("SessionUserAgentSampleReqPacketHandler : {}", message);
